...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IF.Manager.Contracts.Model.IFPageGridHeaderAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("IFPageGridHeaderAction");
                });
            ...
            modelBuilder.Entity("IF.Manager.Contracts.Model.IFPageGridRowAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IF.Manager.Contracts.Model.IFPageGrid", b =>
                {
                    ...
                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnName("IFPageGrid_Description")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IF.Manager.Contracts.Model.IFPageGridHeaderAction", b =>
                {
                    b.HasOne("IF.Manager.Contracts.Model.IFPageGrid", "Grid")
                        .WithMany("GridHeaderActions")
