...
namespace IF.Manager.Persistence.EF.Migrations
{
    ...
    [Migration("20201201172030_12-1-2020-1")]
    partial class _12120201
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IF.Manager.Service.Model.CustomClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("CustomClassGroupId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomClassGroupId");

                    b.ToTable("CustomClass");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.CustomClassGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("CustomClassGroup");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.CustomClassProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("CustomClassId");

                    b.ToTable("CustomClassProperty");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.CustomClassRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("MainCustomClassId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RelatedCustomClassId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MainCustomClassId");

                    b.HasIndex("RelatedCustomClassId");

                    b.ToTable("CustomClassRelation");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.IFCustomClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("IFCustomClass");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.IFCustomClassProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("IFCustomClassId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IFCustomClassId");

                    b.ToTable("IFCustomClassProperty");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.IFCustomClassRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("MainIFCustomClassId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RelatedIFCustomClassId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MainIFCustomClassId");

                    b.HasIndex("RelatedIFCustomClassId");

                    b.ToTable("IFCustomClassRelation");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.IFKClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("IF.Manager.Service.Model.CustomClass", b =>
                {
                    b.HasOne("IF.Manager.Service.Model.CustomClassGroup", "Group")
                        .WithMany("CustomClasses")
                        .HasForeignKey("CustomClassGroupId");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.CustomClassProperty", b =>
                {
                    b.HasOne("IF.Manager.Service.Model.CustomClass", "CustomClass")
                        .WithMany("CustomClassProperties")
                        .HasForeignKey("CustomClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("IF.Manager.Service.Model.CustomClassRelation", b =>
                {
                    b.HasOne("IF.Manager.Service.Model.CustomClass", "MainCustomClass")
                        .WithMany("Relations")
                        .HasForeignKey("MainCustomClassId");

                    b.HasOne("IF.Manager.Service.Model.CustomClass", "RelatedCustomClass")
                        .WithMany("ReverseRelations")
                        .HasForeignKey("RelatedCustomClassId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("IF.Manager.Service.Model.IFCustomClassProperty", b =>
                {
                    b.HasOne("IF.Manager.Service.Model.IFCustomClass", "IFCustomClass")
                        .WithMany("IFCustomClassProperties")
                        .HasForeignKey("IFCustomClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("IF.Manager.Service.Model.IFCustomClassRelation", b =>
                {
                    b.HasOne("IF.Manager.Service.Model.IFCustomClass", "MainIFCustomClass")
                        .WithMany()
                        .HasForeignKey("MainIFCustomClassId");

                    b.HasOne("IF.Manager.Service.Model.IFCustomClass", "RelatedIFCustomClass")
                        .WithMany()
                        .HasForeignKey("RelatedIFCustomClassId");
                });

            modelBuilder.Entity("IF.Manager.Service.Model.IFKClass", b =>
                {
                    b.HasOne("IF.Manager.Service.Model.IFKClass", "Parent")
                        .WithMany("Childrens")
                        .HasForeignKey("ParentId");
                });
